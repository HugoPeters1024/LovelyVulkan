...
namespace lv {
    void ComputeShader::createDescriptorSetLayout(AppContext& ctx) {
    ...
    void ComputeShader::createPipelineLayout(AppContext &ctx) {
    ...
    void ComputeShader::createPipeline(AppContext &ctx, const char *filePath) {
    ...
    void ComputeShader::buildCore(AppContext& ctx) {
        logger::debug("Core of comp shader being build");
        createDescriptorSetLayout(ctx);
        createPipelineLayout(ctx);
        createPipeline(ctx, filePath);
    }

    void ComputeShader::destroyCore(AppContext& ctx) {
